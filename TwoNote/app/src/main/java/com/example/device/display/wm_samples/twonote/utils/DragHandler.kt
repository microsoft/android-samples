...
import com.example.device.display.wm_samples.twonote.models.SerializedImage
...
class DragHandler(private val fragment: NoteDetailFragment) {
    ...
    fun onDrag(event: DragEvent): Boolean {
        ...
        val isRotated = isRotated(fragment.requireContext(), fragment.isDualScreen())
        ...
        item?.let {
            ...
            if (uri != null) {
                if (ContentResolver.SCHEME_CONTENT == uri.scheme) {
                    ...
                    ActivityCompat.requestDragAndDropPermissions(fragment.requireActivity(), event)
